...
module program_count_tb;
    ...
    reg [31:0] pc_in, pc_out, pc_plus_4, alu_result, imm;
    ...
    initial begin
        ...
        imm         = 32'h0000_FFFF;
        check(32'h0000_FFFF, 32'h0000_0004);
        ...
        imm         = 32'h0C00_DDDD;
        check(32'h0C00_DDDD, 32'h0000_0004);
        ...
        imm         = 32'hFFFF_FFFF;
        check(32'hFFFF_FFFF, 32'h0000_0004);
        ...
        imm         = 32'h0000_0004;
        check(32'h0000_080C, 32'h0000_080C);
        ...
        imm         = 32'h0DCC_0008;
        check(32'h0DCC_0008, 32'h0000_0004);
        ...
        alu_result  = 32'h0DCC_AFDE;
        imm         = 32'hF003_0000;
        check(32'hF003_0004, 32'h0000_0008);
